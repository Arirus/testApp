...
public class MainActivity extends AppCompatActivity {
  ...
  public static final String ARIRUS = "ARIRUS";
  ...
  public static class TestAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      return viewType == 1 ? new AlphaHolder(
          LayoutInflater.from(parent.getContext()).inflate(R.layout.alpha_item, parent, false)) :
          new NormalHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.normal_item, parent, false));
    }
  ...
  public interface AlpahCallBack {
    void call();
  }
